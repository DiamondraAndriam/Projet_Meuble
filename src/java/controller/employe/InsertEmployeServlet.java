...
public class InsertEmployeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Employe perso = new Employe(nom, prenom);
            String dateNaissance = request.getParameter("date_naissance");
            String dateEmbauche = request.getParameter("date_embauche");
            perso.setDateEmbauche(dateEmbauche);
            perso.setDateNaissance(dateNaissance);
            
            perso.save(null);
            
            response.sendRedirect("index.jsp");
        } catch (Exception ex) {
            Logger.getLogger(InsertEmployeServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
