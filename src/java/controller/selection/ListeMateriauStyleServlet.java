 ...
 * @author HERINIAINA
 */
@WebServlet(name = "ListeMateriauStyleServlet", urlPatterns = {"/ListeMateriauStyle"})
public class ListeMateriauStyleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            style.findById(null);
            List<Materiau> materiau = style.selectMateriau(null);
