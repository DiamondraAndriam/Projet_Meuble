...
import controller.selection.GetMateriauxStyle;
 ...
 * @author HERINIAINA
 */
@WebServlet(name = "SetStyleMateriauxServlet", urlPatterns = {"/SetStyleMateriaux"})
public class SetStyleMateriauxServlet extends HttpServlet {
